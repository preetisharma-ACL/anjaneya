...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full flex justify-center z-50 transition-all duration-500">
      ...
      >
        {/* Content Container */}
        <div className={`mx-auto flex items-center justify-between px-24 lg:px-40 transition-all duration-500 ${
          ...
          {/* Logo */}
          <Link to="/" className="shrink-0 flex items-center h-40 py-[20px] lg:py-[20px] box-content cursor-pointer">
        ...
        {/* Mobile Menu Overlay */}
        <div className={`md:hidden absolute top-full left-0 w-full bg-white shadow-xl transition-all duration-500 overflow-hidden ${
          ...
          <div className="flex flex-col px-24">
            ...
            <div className="mt-16 pt-16 border-t border-default flex items-center gap-12 sm:hidden">
              ...
              <span className="text-primary font-medium">+91 73111 03111</span>
            </div>
          </div>
        </div>
      </div>
